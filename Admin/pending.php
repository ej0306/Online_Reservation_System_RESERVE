...
<head>
  ...
  <title>Pending Reservations - <?php include('../includes/titlepage.php');?></title>
...
include('../includes/dbconnect.php');
    ...
    $query=mysqli_query($connect,"select * from reservation_made  where r_status='Pending'")or die(mysqli_error($con));
