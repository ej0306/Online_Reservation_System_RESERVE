...
<head>
  ...
  <title>Cancelled Reservations - <?php include('../includes/titlepage.php');?></title>
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">Cancelled Reservations</a>
...
include('../includes/dbconnect.php');
    ...
    $query=mysqli_query($connect,"select * from reservation_made  where r_status='Cancelled'")or die(mysqli_error($con));
