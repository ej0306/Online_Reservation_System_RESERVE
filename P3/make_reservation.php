...
<body>
    <div class="Container00">
        <div class="section00"><h2>Make Reservation</h2></div>
        <div class="sheet">
        <div class="error">
        ...
        <fieldset>    
            ...
            <br>
            <input type="text" name="first_name" size="15" maxlength="20" value="<?php if (isset($_POST['first_name'])) echo $_POST['first_name']; ?>"/><span>* <?php echo $fnameErr;?></span>
            

            <label for="last_name">Last Name:</label>
            <br>
            <input type="text" name="last_name" size="15" maxlength="40" value="<?php if (isset($_POST['last_name'])) echo $_POST['last_name']; ?>"/><span class="error">* <?php echo $lnameErr;?></span>
            ...
            <label for="people_dining">Number of Guests:</label>
            <br>
            ...
            <label for="party">Enter Date and Time (MM-DD-YYYY HH:MM):
        ...
        <fieldset>
            ...
            <label for="seating_position">Seating Preferences:</label>
            <br> 
          ...
          <?php
            ...
            <p style="text-align:center"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">SUCCESS! CLICK HERE FOR DETAILS</button></p>
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div>
                        ...
                        <p>
                        <?php
                            echo "<h5 style='text-align:center'>Thank You"." $fn".", "."$ln </h5>";
